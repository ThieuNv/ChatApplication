...
public class ChatAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            holder.ivLeft = (ImageView) convertView.findViewById(R.id.imgvLeft);
            holder.ivRight = (ImageView) convertView.findViewById(R.id.imgvRight);
        ...
        final ImageView imgView = isMe ? holder.ivRight : holder.ivLeft;

        Picasso.with(getContext()).load(getProfileGravatar(message.getUserId())).into(imgView);
